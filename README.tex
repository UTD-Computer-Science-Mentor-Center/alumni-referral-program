...
\minSemesters{} semesters at the CSMC.
...
\includesvg[inkscapelatex=false,width=\linewidth]{./graphics/requester_to_referrer}\label{fig:requesterToReferrer}
...
\includesvg[inkscapelatex=false,width=\linewidth]{./graphics/referrer_to_requester}\label{fig:referrerToRequester}
